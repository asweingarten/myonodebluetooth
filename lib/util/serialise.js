...
class Serialise {
     ...
     * @returns {Buffer}
     */
    command_set_mode(sendImu=true, sendClassifier=true, sendEmg=true){
        // TODO: Let dev have more than binary choice
        let emg_mode = sendEmg ? this.emg_mode_t.emg_mode_send_emg : this.emg_mode_t.emg_mode_none;
        let imu_mode = sendImu ? this.imu_mode_t.imu_mode_send_all : this.imu_mode_t.imu_mode_none;
        let classifier_mode = sendClassifier ? this.classifier_mode_t.classifier_mode_enabled : this.classifier_mode_t.classifier_mode_disabled;
